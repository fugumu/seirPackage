...
showtext::font_add("kaiti","STKAITI.TTF")
...
seirplot<-ggplot2::ggplot(data=result)+
  ...
  ggplot2::scale_color_manual(name="SEIR",
          values = c("S"="orange","E"="purple","I"="red","R"="green"))
seirplot
ggplot2::ggsave(seirplot,filr="seir.pdf",width=7,height =6 )
ggplot2::ggsave(seirplot,filr="seir.svg",width=7,height =6 )
